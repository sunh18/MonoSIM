...
glo._init()
glo.set_value('warmup_or_main','warmup')
glo.set_value('output_name','output_38_v6_label_roi_backbone_batchsize_2_lr_0.004')
glo.set_value('m3drpn_spilt1_train_list_path','/data/szb/M3D-RPN/data/kitti_split1/train.txt')
# glo.set_value('pvrcnn_shared_features_path','/data/szb/distill_detection/OpenPCDet/output/kitti_models/pv_rcnn/pred_result/shared_features')
# glo.set_value('pvrcnn_roi_grid_points_path','/data/szb/distill_detection/OpenPCDet/output/kitti_models/pv_rcnn/pred_result/global_roi_grid_points')
# glo.set_value('pvrcnn_cloud_points_path','/data/szb/distill_detection/OpenPCDet/output/kitti_models/pv_rcnn/pred_result/cloud_points')
...
def Config():
    ...
    conf.model = 'densenet121_3d_dilate(model_v3)'
