...
def Config():
    ...
    conf.model = 'densenet121_3d_dilate_depth_aware_for_MonoSIM'
    ...
    # pretrained model
    conf.pretrained = '/nas_data/sunhan/MonoSIM_m3drpn_waymo/pretrained_ckpt/warmup_pkl'
    
    # warmup or main
    conf.is_main = True
    
    # use simulation
    conf.scene_level_simulation = True
    conf.RoI_level_simulation = True
